...
export APP_SECRET_DESCRIPTION=secret
...
az ad app create --display-name $APP_NAME --password $APP_SECRET --credential-description $APP_SECRET_DESCRIPTION --required-resource-accesses @manifest.json > /dev/null
